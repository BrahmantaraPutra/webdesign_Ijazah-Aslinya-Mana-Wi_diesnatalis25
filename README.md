...
Berpartisipasi dalam kegiatan seperti penanaman pohon, bersih-bersih pantai, daur ulang, dan donasi
...
Lokasi tempat daur ulang terdekat (jika ingin menambahkan peta interaktif)
...
Berbagi cerita, ide, ataupun inisiatif baru
Membuat topik diskusi seperti grup WhatsApp/Discord tetapi versi web
Forum menjadi tempat berkumpulnya orang-orang yang peduli pada bumi.

Dengan hadirnya Echopedia, kami berharap semakin banyak orang yang terinspirasi untuk mengambil bagian dalam menjaga kelestarian bumi. Setiap tindakan kecil memiliki dampak besar ketika dilakukan bersama. Melalui edukasi, kampanye, pengelolaan sampah, ruang hijau, galeri, dan forum diskusi, Echopedia menjadi wadah bagi siapa pun yang ingin berkontribusi dalam menciptakan masa depan yang lebih bersih, sehat, dan berkelanjutan.

Bersama Echopedia, mari melangkah menuju dunia yang lebih hijau—dimulai dari langkah sederhana hari ini. 🌿🌎

## Persyaratan 

- Node.js v18+ dan npm
- Koneksi internet untuk mengclone project

## Instalasi

- Salin tautan Repositori
- Buat folder baru
- Buka terminal lewat folder tersebut
- Lalu jalankan perintah berikut

```sh
# Step 1: Clone Repositori dengan perintah di bawah
git clone <Masukan Tautan>

# Step 2: Masuk ke project
cd <Nama Folder EcoPedia>

# Step 3: Install Package npm
npm install

# Step 4: Menjalankan tampilan Website
npm run dev
```

## Cara Menjalankan Project

Masuk ke local host **Tautan yang muncul di terminal** Atau Ketik di Browser **http://localhost:8080/** 
